...
import { CommunicationFieldContainer } from '@/components/Architecture/components/CommunicationField/CommunicationField.styles';
import {
...
const CommunicationField = (): React.ReactElement => {
  const settings = {
    infinite: true,
    speed: 500,
    slidesToShow: 1,
  ...
  return (
    <Fragment>
      <ElectricalFieldTextWrpper>
        ...
        <h5>
          설계본부는 1990년도부터 전기철도분야를 주축으로 송,변전설비, 공항, 도로, 공공 시설 및 기타의 전기설계에 대하여 많은 기본 및 실시설계 경험을 갖고있으며 그러한 바탕으로
