    ...
    return (
        <Fragment>
            <ElectricalFieldTextWrpper>
                ...
                <h5>
                    철도신호설계부는 2012년도부터 도시철도를 주축으로 광역철도 및 고속철도의 철도신호설계에 대하여 많은
                    기본 및 실시설계 경험을 갖고있으며 그러한 바탕으로 기술역량에 대한 무한한 잠재력과 사업수행능력을
                    인정받아 사업영역을 성공적으로 넓혀왔으며 앞으로 이와 같은 신뢰를 바탕으로 철도신호설계 분야를
                    더더욱 발전시킬 것입니다.
                </h5>
            </ElectricalFieldTextWrpper>
